...
var deviceModel = {
    ...
    loadGoogleMaps : function () {
        ...
        $.getScript('https://maps.googleapis.com/maps/api/js?v=3.24&key=AIzaSyDMqebRgrnjtlQwcRTEvYf1McbcGLSevBk&libraries=places&sensor=true&callback=deviceModel.onGoogleMapsLoaded');
    },
