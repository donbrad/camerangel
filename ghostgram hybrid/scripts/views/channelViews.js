...
*/
   ...
   loadImagesThenScroll : function () {
    ...
    addSmartObjectToMessage: function (objectId, smartObject) {
        ...
        var objectUrl = '<a data-role="button" class="btnSmart" data-objectid="'+ objectId + '" id="chatobject_' + objectId + '" data-click="channelView.onObjectClick" /><img src="images/smart-event-light.svg" class="icon-sm"/> '  + " - " + smartObject.title + '</a>';
