	...
	$("#channelMembers-listview").kendoMobileListView({
		...
		click: function (e) {
			...
			if (thisMember.contactUUID === null) {
				...
				updateParseObject('channels', 'channelId', APP.models.channels.currentModel.channelId, 'invitedMembers', APP.models.channels.currentModel.invitedMembers);
			} else {
				APP.models.channels.currentChannel.members.push(thisMember.contactUUID);
				updateParseObject('channels', 'channelId', APP.models.channels.currentModel.channelId, 'members', APP.models.channels.currentModel.members);
			}
			APP.models.channel.membersDS.sync();
