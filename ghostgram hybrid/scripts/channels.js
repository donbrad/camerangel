	...
	$("#channelMembers-listview").kendoMobileListView({
		...
		click: function (e) {
			...
			if (thisMember.contactUUID === null) {
				...
				updateParseObject('channels', 'channelId', APP.models.channels.currentChannel.channelId, 'invitedMembers', APP.models.channels.currentChannel.get('invitedMembers'));
			} else {
				APP.models.channels.currentChannel.members.push(thisMember.contactUUID);
				updateParseObject('channels', 'channelId', APP.models.channels.currentChannel.channelId, 'members', APP.models.channels.currentChannel.get('members'));
			}
			APP.models.channel.membersDS.sync();
